package com.jimmy.portal.aspects;
...
import com.jimmy.portal.exception.RegistrationValidationException;
...
public class RegisterValidationAspect {
    ...
    @Before("""
        execution(* com.jimmy.portal.auth.controller.AuthController
        .registerUser(..))
        """)
    public void validateBeforeRegister(JoinPoint joinPoint) {
        ...
        Optional<JobPortalUser> existingUser =
                jobPortalUserRepository.findByEmailOrMobileNumber(
